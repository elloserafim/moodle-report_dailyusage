    ...
    class StatsEnhanced 
    {
		...
		************************************/
        public function checkStatsTableExists() {
            ...
            //$query = "SELECT * FROM ".$this->prefix."report_daily LIMIT 1";
		...
		*  getStats
		*
        *  Gets statistics from 'mdl_daily' if they exist
                ...
                if ($logs = $DB->get_records_sql($query)) {
                    ...
                    foreach($count_ac as $key => $value) {
                        ...
                        if (($key == 1 || $key == 2 || $key == 3 || $key == 5)) {
							...
							//$query = "SELECT * FROM ".$this->prefix."report_daily WHERE time_start = $start_date AND time_end = $end_date AND role_id = $key AND stat_type = '$stat_type'";
